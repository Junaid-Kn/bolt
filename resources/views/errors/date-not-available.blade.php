    ...
    <div class="max-w-4xl mx-auto px-4">
        <x-filament::section :compact="true">
            ...
            <x-slot name="description">
                ...
                <span class="text-sm">{{ $zeusForm->start_date->format(\Filament\Schemas\Schema::$defaultDateTimeDisplayFormat) }}</span>,
                <span class="text-sm text-gray-500">{{ __('End date') }}</span>:
                <span class="text-sm">{{ $zeusForm->end_date->format(\Filament\Schemas\Schema::$defaultDateTimeDisplayFormat) }}</span>
            </x-slot>
        </x-filament::section>
    </div>
</div>
